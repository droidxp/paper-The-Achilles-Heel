...
\rb{{\bf Note:} in Section~\ref{sec:discussion}, we show that our results remain consistent across three additional scenarios:
when classifying a repackaged version of an app as malware if at least one, five, or ten VirusTotal engines flag it as malicious.}
...
\rb{In Section~\ref{sec:discussion} we }
