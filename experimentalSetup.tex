...
larger than the datasets used at Bao et al.’s study~\cite{DBLP:conf/wcre/BaoLL18}. Accordingly,
...
a small dataset (\sds) used in the original study~\cite{DBLP:conf/wcre/BaoLL18}.
...
of them from the Gappusin (46.18\%) family. Despite being flagged as malicious by at least two security engine, unfortunately \avt cannot correctly identify the family of 253 samples from our \cds.
...
Our \cds has an average similarity score of 90.39\%, with the following distribution: 87 of
...
It is important to highlight that our samples come from different Android app stores. Most of our repackaged apps come from a non-official
