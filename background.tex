...
There are many tools available that help developers reverse engineer Android bytecode.~\cite{DBLP:conf/issta/WangGMC15}.
...
like contact list or resources are granted through specific APIs, known as sensitive APIs, which are managed by coarse-grained Android permissions system~\cite{DBLP:journals/corr/abs-2109-06613}.
