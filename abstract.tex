...
\fh{To address these concerns, this paper shows a replication study focused on evaluating the accuracy of the \mas. Unlike previous studies, our research employs a dataset that is an order of magnitude larger, comprising \apps
