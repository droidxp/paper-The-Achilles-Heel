...
label an original app as a malware. \rb{Also, we label a repackaged version of an app as malware
  ...
  raise concerns about construct validity.}
\fh{However, when we relax this constraint and label an asset as malware whenever at least one engine detects suspicious behavior, precision improves to 0.85,
